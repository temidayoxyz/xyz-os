...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-deep-tariff': { kind: 'none', reason: 'Browser-side billing-window readout; classifies no model request and registers nothing model-facing.' },
  ...
  'packages/llm/deep-tariff': { kind: 'none', reason: 'The tariff resolver classifies official DeepSeek billing windows for host and UI consumers and registers nothing model-facing.' },
